	...
	var DateTimeField = (function (_Component) {
	  ...
	  function DateTimeField() {
	    ...
	    this.componentWillReceiveProps = function (nextProps) {
	      if ((0, _moment2["default"])(nextProps.dateTime, nextProps.format, nextProps.locale, true).isValid()) {
	        return _this.setState({
	          viewDate: (0, _moment2["default"])(nextProps.dateTime, nextProps.format, nextProps.locale, true).startOf("month"),
	          selectedDate: (0, _moment2["default"])(nextProps.dateTime, nextProps.format, nextProps.locale, true),
	          inputValue: (0, _moment2["default"])(nextProps.dateTime, nextProps.format, nextProps.locale, true).format(_this.resolvePropsInputFormat(nextProps))
	        });
	      }
